...
print("Scaler saved: processed/scaler.pkl")

#=====================================================
#  Save Column Order  ← NEW
#=====================================================

with open("processed/columns.pkl", "wb") as f:
    pickle.dump(list(X.columns), f)

print("Column order saved: processed/columns.pkl")
...
processed/scaler.pkl     ← NEW
processed/columns.pkl    ← NEW
""")
